    ...
    <section className="w-full min-h-screen text-gray-600 text-white bg-[#000] body-font overflow-hidden lg:pt-[80px] flex flex-col justify-between">
      <div className="container px-5 pt-[70px]  mx-auto w-full">
        <div className="w-full mx-auto flex flex-col lg:flex-row ">
          ...
          <div className=" w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-col justify-between">
            <div className="  ">
                  ...
                  {product && (
                    <div className="space-y-4  ">
                      <button
                        ...
                        className="flex w-full justify-center items-center text-white bg-secondary  border-0 py-4 px-6 focus:outline-none hover:bg-primary rounded space-x-2"
                      >
                        <h3>Add to cart</h3>
                      ...
                      <button
                        ...
                        className="flex w-full justify-center items-center text-white bg-[#2e2e2e] black  border-0 py-4 px-6 focus:outline-none hover:bg-[#8d0000] rounded space-x-2"
                      >
